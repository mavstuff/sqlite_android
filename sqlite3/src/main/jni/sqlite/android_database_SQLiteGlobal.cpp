...
extern "C" AAssetManager* g_pAssetManager = NULL;
...
static void nativeRegisterAssetManager(JNIEnv* env, jclass clazz, jobject assetManager) {
    g_pAssetManager = AAssetManager_fromJava(env, assetManager);
    ALOG(LOG_VERBOSE, SQLITE_LOG_TAG, "nativeRegisterAssetManager OK (%p)\n", g_pAssetManager);
}
...
static const JNINativeMethod sMethods[] =
{
    ...
    { "nativeRegisterAssetManager", "(Landroid/content/res/AssetManager;)V", (void*)nativeRegisterAssetManager },
};
